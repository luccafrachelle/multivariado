...
#str(DG)
res <- NbClust(data=NULL, diss=DG, distance=NULL, method="ward.D", index="cindex")
res <- NbClust(data=NULL, diss=DG, distance=NULL, method="ward.D", index="silhouette")
res <- NbClust(data=NULL, diss=DG, distance=NULL, method="ward.D", index="mcclain")
```
...
```{r}
#no funciona
NbClust(data=NULL, diss=DG, distance = "NULL" , method = "ward.D")
```
