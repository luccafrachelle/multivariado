...
$$\delta_{ij}=\frac{1}{T}\sum^T_{t=1} \delta_{ijt}$$
donde $\delta_{ijt}$ es la similaridad entre ambos individuos en la variable t y $T$ es la cantidad de variables.
...
grid.arrange(a2,b2,c2,d2, e2,f2,ncol=3)
```
