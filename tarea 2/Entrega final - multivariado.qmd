...
Dada la información obtenida de los gráficos de codo y silueta, se procede a realizar un análisis de cluster con 5 grupoC. Ya que el gráfico de codo no presenta un punto de inflexión claro se opta por un punto medio entre silueta y codo.
