...
No hay nada muy revelador en el PCA, quizas lo que más llame la atención sea como se openen la cantidad de dientes operados a la cantidad de dientes con caries. Se toma a las variables S,C,P,O como numéricas para ver como se relacionan con la edad. No es necesario tomar CPO ya que es una combinación lineal de las otras y no agrega información al PCA.
